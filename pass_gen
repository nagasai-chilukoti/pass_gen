...
username_label = tk.Label(root, text="Enter Username:", bg=background_color)
...
generate_button = tk.Button(root, text="Generate Password", command=generate_password, bg=button_color, fg=button_text_color)
generate_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10, sticky="we")

reset_button = tk.Button(root, text="Reset", command=reset_password, bg=button_color, fg=button_text_color)
